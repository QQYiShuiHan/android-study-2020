...
import com.vincent.android_study_2020.utils.DeviceDimensionUtil;
...
public class AudienceListView extends RecyclerView {
	...
	private void init(Context context) {
		mContext = context;
		// 每个用户 item 的宽度
		itemViewWidth = DeviceDimensionUtil.dip2px(mContext, 40);
		...
		addItemDecoration(new RecyclerView.ItemDecoration() {
			...
			public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
				...
				if (linearGradient == null || preWidth != parent.getWidth()) {
					...
					linearGradient = new LinearGradient(parent.getWidth() - (itemViewWidth * 3), 0.0f, parent.getWidth(), 0.0f, new int[]{Color.BLACK, 0}, null, Shader.TileMode.CLAMP);
